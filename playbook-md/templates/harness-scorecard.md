...
> **Start here instead:** this static template is the manual fallback. For most teams the better starting
> point is the skill-driven [Harness Adoption Starter](../../harness-adoption/README.md) — point an agent at
> its [`assess` skill](../../harness-adoption/skills/assess.md) and it detects your stack, scores the five
> layers, and *generates* a fitted scorecard for you rather than making you fill one in by hand. Fill this
> template in directly only when you can't run an agent against the repo.
