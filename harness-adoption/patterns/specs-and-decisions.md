...
contract (inputs/outputs/invariants), out-of-scope, acceptance. Status in
frontmatter (`draft → approved → implemented`). The agent writes a spec
before building anything non-trivial; review checks code against it.
